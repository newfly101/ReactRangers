...
import classes from "../../css/feed/FeedTopText.module.css";
            ...
            <div className={classes.subscribeInfo}>
              ...
              <div className={classes.subscribeWrapper}>
                {feedStore.feedPage === 'Follower' || feedStore.feedPage === 'Following' ?
                  ...
                  <><span className={classes.subscribingNum} onClick={feedStore.clickSubscribeing}> 구독중 <span
                    className={classes.subscribeNum}>0</span>
                    </span>
                    <span className={classes.subscribingNum} onClick={feedStore.clickSubscribed}> 구독자 <span
                      className={classes.subscribeNum}>0</span>
                </span></>
                }
              </div>
