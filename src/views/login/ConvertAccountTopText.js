...
import classes from "../../css/login/ConvertAccountTopText.module.css";

const ConvertAccountTopText = () => {
  return (
...
export default ConvertAccountTopText;
